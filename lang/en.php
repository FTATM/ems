...
$lang = [
    ...
    "datalasttime"=> "Data Last Time",
    "refreshevery"=> "Refresh every",
    "seconds"=> "Seconds",  
    "voltageintegratedgauge"=> "Voltage Integrated Gauge",
    "realtime_phase_to_neutral_and_phase_to_phase"=> "Real-time Phase-to-Neutral &amp; Phase-to-Phase",
    "livefeed"=> "LIVE FEED",
    "minutes"=> "minutes",
    "hour"=> "hour",
    "hours"=> "hours",
    ...
    "last_minutes" => "minutes ago",
    "last_minute"  => "minute ago",
    "last_hour"    => "hour ago",
    "last_hours"   => "hours ago",
    "last_day"     => "day ago",
    "last_days"    => "days ago",
    "last_week"    => "week ago",
    "last_month"   => "month ago",
    "last_months"  => "months ago",
    "last_year"    => "year ago",
    ...
    "notee" => "Note: Electricity pricing is not time-dependent...",
    "monthlyreport"=> "Monthly Report",
    "powerfactor"=> "Power Factor",
    "servicecharge"=> "Service Charge",
    'fuel_adjustment_charge' => 'Fuel Adjustment Charge (FT)',
    'total_electricity_charge' => 'Total Electricity Charge',
    'tax' => 'Tax Amount',
