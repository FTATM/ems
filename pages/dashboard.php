        ...
        <div class="w-100 h-100 d-flex flex-column justify-content-center">
            ...
            <div class="w-100 d-flex flex-wrap gap-4 justify-content-center">
                <div class="d-flex w-90 flex-wrap justify-content-between ">
                    ...
                    <div class="summary bg-white fs-3 d-flex">
                        <div class="bg-danger" style="min-width: 30%; min-height: 100%;"></div>
                        <div class="text-center w-100">
                            <h5>summary</h5>
                            54
                        </div>
                ...
                <div class="d-flex flex-wrap justify-content-between" style="width: 90%;">
                    <div class="" id="chart-bar" style="width: 49%; min-height: 400px; background-color: <?= $bgsec ?>;"></div>
                    <div class="" id="chart-pie" style="width: 49%; min-height: 400px; background-color: <?= $bgsec ?>;"></div>
                </div>
                <div class="" id="chart-linear" style="width: 90%; min-height: 400px; background-color: <?= $bgsec ?>;"></div>
            </div>
        </div>
