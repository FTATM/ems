                ...
                <div class="d-flex flex-column">
                    <div class="px-4 d-flex justify-content-start my-3 gap-2 bg-white bg-opacity-10 py-3">
                        <div class="d-flex align-items-center gap-2" style="width: 35svw;">
                            <label for="select-meters" class="form-label form-label-sm text-end w-50"
                                style="max-width: 15vw;">Select meter :</label>
                            ...
                            <select id="select-time" class="form-select form-select-sm w-50"
                                onchange="checkTimeChange()">
                        ...
                        <div class="d-flex align-items-center gap-2" style="width: 15svw;">
                            ...
                            <input type="number" id="input-refresh" class="form-control form-control-sm ms-2 w-25"
                                style="max-width: 15vw;" placeholder="Refresh every (seconds)" value="5" min="1"
