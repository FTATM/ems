                    ...
                    <div class="d-flex bg-white bg-opacity-10 p-3 w-100">
                        <div class="w-25">
                            ...
                            <div class="d-flex my-2">
                                <div class="w-50 pe-1">
                                    <h4><?= $lang['from'] ?></h4>
                                    <input id="datetime-from" type="date" class="form-control form-control-sm"
                                        value="2025-09-30" onchange="filterMeters()">
                                </div>
                                <div class="w-50 ps-1">
                                    <h4><?= $lang['to'] ?></h4>
                                    <input id="datetime-to" type="date" class="form-control form-control-sm"
                                        value="2025-10-30" onchange="filterMeters()">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white bg-opacity-10 p-3 w-100">
                        <div class="d-flex justify-content-between align-items-center px-2">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <input id="csv" class="btn btn-sm border-1 bg-primary" style="width: 30%;" value="CSV"
                                    onclick="sendExportToEmail('csv')">
                                <input id="excel" class="btn btn-sm border-1 bg-primary" style="width: 30%;"
                                    value="Excel" onclick="sendExportToEmail('excel')">
                            </div>
                        </div>
                        <div class="d-flex w-100 align-items-center justify-content-between p-2 rounded shadow-sm">
                            <div class="form-check me-3">
                                <input id="is-table-all-value" type="checkbox" class="form-check-input"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <select id="select-table-show" class="form-select form-select-sm w-auto"
                                    onchange="ReloadTable()">
