...
<body style="background-color: <?= $bg ?>; color: <?= $text ?>!important; min-height: 100svh;">
    <div id="main" class="d-flex">
        ...
        <div class="w-100 h-100 d-flex flex-column justify-content-center">
            ...
            <div class="bg-secondary bg-opacity-25 d-flex flex-wrap m-3 gap-3 align-items-center py-2">
                ...
                <select id="select-meters" class="form-select bg-secondary border-0 text-white" style="width: 15%;"
                    onchange="filterDataInMeters()"> </select>
                <label for="select-filter-value">Last time : </label>
                <select id="select-filter-value" class="form-select bg-secondary border-0 text-white"
                    style="width: 10%;" onchange="filterDataInMeters()">
                ...
                <label for="input-refresh" class="form-label form-label-sm text-end w-10"
                    style="max-width: 15vw;">Refresh every :</label>
                <input type="number" id="input-refresh" class="form-control form-control-sm ms-2" style="width: 100px;"
                    placeholder="Refresh every (seconds)" value="15" min="1" max="30" onchange="setRefreshTime()">
            ...
            <div class="d-flex p-3">
                <div class="d-flex flex-column gap-3" style="width: 90%;">
                    <div class="w-100 d-flex flex-wrap justify-content-between">
                        <div class="rounded w-25 px-2" id="chart-Pie" style="min-height: 400px;  max-width: 350px;">
                        </div>
                        <div class="rounded w-75 px-2" id="chart-linear" style="min-height: 400px; max-width: 1200px;">
                        </div>
                    </div>
                    <div class="w-100 d-flex flex-wrap justify-content-between">
                        <div class="js-gauge demo gauge bg-secondary bg-opacity-10"></div>
                        <div class="rounded w-75 px-2" id="chart-linear-price"
                            style="min-height: 400px; max-width: 1200px;"></div>
                    </div>
                </div>
                <div class="w-25">
    ...
    <?php include "../scripts/scriptjs-dashboard-old.html"; ?>
</body>
