...
<body style="background-color: <?= $bg ?>; color: <?= $text ?>!important; min-height: 100svh;">
    <div id="main" class="">
        ...
        <div class="container mx-auto " style="max-width: 500px; margin-top: 20px;">
            <form class="p-4 bg-white bg-opacity-10 rounded shadow-sm" method="POST" action="../config/create-user.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="id_card" id="id_card" placeholder="13 หลัก"
